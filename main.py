...
# DOES NOT SUPPORT CREDIT INVOICES, BUT WILL SKIP THEM
...
conn = sqlite3.connect(dir_path + "invoice.db")
c = conn.cursor()
...
for pdf in files:
    ...
    invoice_date = ''
    invoice_no = ''
    if 'Credit Invoice' in long_list:
        continue
    ...
    for x, y in zip(mark_first, mark_last):
        ...
        if y-x == 5:
            ...
            VALUES('{0}', '{1}', '{2}', {3}, '{4}', '{5}', '{6}', {7}, {8}) '''.format(invoice_no, invoice_date,
